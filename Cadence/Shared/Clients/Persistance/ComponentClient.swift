...
struct ComponentClient {
    ...
    var create: (String, Component) -> Effect<Component, ComponentClient.Failure>
    var update: (Component) -> Effect<Component, ComponentClient.Failure>
    var batchUpdate: ([AnyHashable: Any], [Component]) -> Effect<[Component], ComponentClient.Failure>
    var delete: (Component) -> Effect<Never, Never>
}

extension ComponentClient {
